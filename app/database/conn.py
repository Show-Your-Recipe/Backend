...
class SQLAlchemy:
    ...
    def init_app(self, app: FastAPI, **kwargs):
        ...
        #self._engine = create_engine(db_url, pool_size=5, max_overflow=5, echo=True)
        self._engine = create_engine(
            'mysql+pymysql://root:mymypassword@34.64.236.134/mychef_api?charset=utf8mb4',
            echo=echo,
        ...
        if is_testing:  # create schema
            ...
            except_schema_db_url = f"{db_url.drivername}:mymypassword//{db_url.username}@{db_url.host}"
